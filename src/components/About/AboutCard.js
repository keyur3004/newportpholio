      ...
      <div>
        <blockquote className="blockquote mb-0" data-aos="fade-up" data-aos-easing="ease">
          <p className="light" style={{ textAlign: "justify" }}>
            Hello! My name is <span className="white">Abhi Shobhashana </span> and  I enjoy creating things that live on the internet. My interest in web development started back in 2014 when I decided to try editing custom web pages — turns out hacking together a custom UI taught me a lot about HTML & CSS!
          </p>       
          ...
          <footer className="blockquote-footer courier">Abhi</footer>
        </blockquote>
      </div>
    </div>
  );
