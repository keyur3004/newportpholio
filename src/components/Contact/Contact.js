        ...
        <Container fluid className="education-section">
            ...
            <Container>
                <h1 className="education-heading">
                    <span className="dark"> Contact </span><strong className="white"> ME </strong>
                </h1>
                <p className="dark">
                ...
                <Row style={{ justifyContent: "center", padding: "10px", paddingTop: "50px" }}>
                    ...
                    >
                        <h3 style={{ fontSize: "1.50rem", paddingTop: "20px" }}>
                            <span className="light" data-aos="fade-up" data-aos-easing="ease">I am available on below social media. You can message me, my inbox is always open. I’ll try my best to get back to you!</span>
                        </h3>

                        <ul className="contact-social-links" style={{ paddingTop: "65px" }}>
                            <li className="social-icons" data-aos="fade-up" data-aos-easing="ease">
                                <a
                            ...
                            <li className="social-icons" data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease">
                                <a
                            ...
                            <li className="social-icons" data-aos="fade-up" data-aos-delay="200" data-aos-easing="ease">
                                <a
